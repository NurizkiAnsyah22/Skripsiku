...
// Fungsi untuk mengambil nomor urut dari ID transaksi terakhir
function getLastTransactionNumber($lastId) {
...
$lastId = $idtran['id_transaksi'];

// Menghitung nomor urut berikutnya
$newNumber = getLastTransactionNumber($lastId) + 1;

// Format ID transaksi baru
$bulan = date("m");
$tahun = date("y");
$format = "TRK-" . $bulan . $tahun . sprintf("%03d", $newNumber);

// Jika nomor urut sudah lebih dari 999, maka kembalikan ke 1
if ($newNumber > 999) {
    $newNumber = 1;
}
                    ...
                    <?php
                        if (isset($_POST['simpan'])) {
                            ...
                            if ($sisa2 < 0) {
                                ...
                                $sql = $koneksi->query("INSERT INTO barang_keluar (id_transaksi, tanggal, kode_barang, nama_barang, jumlah, tujuan, satuan, total) VALUES ('$id_transaksi','$tanggal','$kode_barang','$nama_barang','$jumlah','$tujuan','$satuan','$total')");
