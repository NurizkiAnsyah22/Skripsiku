...
<head>
    ...
    <style>
        ...
        .logo img {
            width: 150px; /* Sesuaikan lebar gambar/logo */
            height: auto;
            margin-right: 10px;
        }
    </style>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
                ...
                <div class="logo">
                    <img src="/img/logo_persada.png" alt="Logo">
                    <!-- Ganti "path_to_your_image/logo.png" dengan jalur file gambar/logo yang sesuai -->
                </div>
            </a>
            ...
            <li class="d-flex align-items-center justify-content-center">
                <a class="nav-link">
                    <img src="img/<?php echo $data['foto'] ?>" class="img-circle" width="80" alt="User" />
                </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link">
                    <div class="d-flex align-items-center justify-content-center" class="name"><?php echo $data['nama']; ?></div>
                    <div class="d-flex align-items-center justify-content-center" class="email">Anda adalah Super Admin</div>
                </a>
            </li>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Nurizkiansyah 2023</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
