       ...
       <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
			...
			<marquee><h2>Selamat Datang di Sistem Informasi Inventory Barang | Created by <a href='https://github.com/NurizkiAnsyah22/' title='Nurizkiansyah' target='_blank'>Nurizkiansyah</a>
      </marquee></h2>
		  <br></br>
          <!-- Content Row -->
          <div class="row">
